...
The maximum file size of the image to operate on. If the file size if
...
PNG files as dropon are supported only if libmodjpeg has been compiled
with PNG support.
