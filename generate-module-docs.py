#!/usr/bin/env python3
# Fetches and as much as possible sanitizes (from extraneous info) official README for a repo.
# input: <handle>
# Saves to docs/<handle>.yml
# Logic: loads nginx-extras/modules/.../...yml first
import argparse
import configparser
...
parser = argparse.ArgumentParser(description='Generate docs for a single module.',
                                 epilog=epilog,
                                 prog='lastversion')
